...
<script type="text/javascript" charset="UTF-8"
	src="<?=URL_PUB?>js/jquery-loading/1.2.0/jquery.loading<?=YAM_MIN?>.js"></script>
<script type="text/javascript" charset="UTF-8"
	src="<?=URL_PUB?>js/jquery-validation/1.15.1/jquery.validate<?=YAM_MIN?>.js"></script>
<script type="text/javascript" charset="UTF-8"
	src="<?=URL_PUB?>js/jquery-validation/1.15.1/additional-methods<?=YAM_MIN?>.js"></script>
<!-- <script type="text/javascript" charset="UTF-8"
	src="<?=URL_PUB?>js/jquery-validation/1.15.1/localization/messages_fr.js"></script> -->
</body>
</html>
<?php
    }
